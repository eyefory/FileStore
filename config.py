...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8191478986:AAG-u7KQUaztCNVFVjCxYVmuT9MFhImQhHQ")
#Your API ID from my.telegram.org
APP_ID = int(os.environ.get("APP_ID", "27671846"))
#Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "cc06a836b64fe700de8a1a318186ad0a")
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002180602624"))
# NAMA OWNER
OWNER = os.environ.get("OWNER", "MonkeyDluffyXbot")
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5628652923"))
#Port
PORT = os.environ.get("PORT", "8030")
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://fladofficial777:n1d643xtGzpy5Lq8@cluster0.6x1lp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002344758126')) #Log channel id ( make sure bot is admin )
...
try:
    ADMINS=[5628652923]
    for x in (os.environ.get("ADMINS", "5628652923").split()):
        ADMINS.append(int(x))
except ValueError:
